    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ארון בגדים 6 דלתות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '46bb5034-4a18-4c52-8850-6c5bda49e2a4',
                    name: data.name || '',
                    email: data.email || '',
